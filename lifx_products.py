...
SWITCH_PRODUCT_IDS = frozenset({70, 71, 84, 89, 115, 116, 226})

MATRIX_PRODUCT_IDS = frozenset({55, 57, 68, 137, 138, 171, 172, 173, 174, 176, 177, 185, 186, 201, 202, 215, 216, 217, 218, 219, 220, 221, 222, 229, 265, 266, 267, 268})

LINEAR_MULTIZONE_PRODUCT_IDS = frozenset({31, 32, 38, 56, 117, 118, 119, 120, 141, 142, 143, 144, 151, 152, 161, 162, 203, 204, 205, 206, 207, 208, 211, 213, 214, 300})

EXTENDED_MULTIZONE_PRODUCT_IDS = frozenset({56, 72, 117, 118, 119, 120, 141, 142, 143, 144, 151, 152, 161, 162, 203, 204, 205, 206, 207, 208, 211, 213, 214})


def product_layout(product: int) -> str:
    """Return 'matrix', 'linear', or 'single' for a LIFX product ID."""
    if product in MATRIX_PRODUCT_IDS:
        return 'matrix'
    if product in LINEAR_MULTIZONE_PRODUCT_IDS or product in EXTENDED_MULTIZONE_PRODUCT_IDS:
        return 'linear'
    return 'single'
